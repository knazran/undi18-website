      ...
      <section id="our_pillars">
        <div className="container mx-auto px-4 py-4 pt-2 lg:px-16 lg:flex">
          <div className="my-4 w-full">
            ...
            <h3 className="text-lg font-normal tracking-wider mb-2">
              1. A.E.I.O Youth
            </h3>
            <h3 className="text-lg font-normal tracking-wider mb-2">
              2. Advocacy
        ...
        <div className="container mx-auto px-4 py-4 pt-2 lg:px-16 lg:flex">
          <div className="my-2 w-full">
            ...
            <div className="flex mt-8">
              <div className="w-1/3">
                <div className="border rounded shadow-md mx-6">
                  <div className="flex flex-col">
                    <div>
                      <img
                        className="w-full m-0 rounded rounded-b-none object-center lg:object-fill h-0 lg:h-full"
              ...
              <div className="w-1/3">
                <div className="border rounded shadow-md mx-6">
                  <div className="flex flex-col">
                    <div>
                      <img
                        className="m-0 w-full rounded rounded-b-none object-center lg:object-fill h-0 lg:h-full"
                        src={qyira} alt="Qyira"
                      />
                    </div>
                    <div className="px-4 py-4 text-center">
              ...
              <div className="w-1/3">
                <div className="border rounded shadow-md mx-6">
                  <div className="flex flex-col">
                    <div>
                      <img
                        className="m-0 rounded rounded-b-none object-center lg:object-fill h-0 lg:h-full"
